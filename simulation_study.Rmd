...
value has been recovered precisely (standard deviation of ~0.001) by the model, 
...
Note that about three quarters of the new counts exceeding the control limit
